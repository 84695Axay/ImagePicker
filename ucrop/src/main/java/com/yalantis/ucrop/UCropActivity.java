...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setupViews(@NonNull Intent intent) {
        mStatusBarColor = intent.getIntExtra(UCrop.Options.EXTRA_STATUS_BAR_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_white));
        mToolbarColor = intent.getIntExtra(UCrop.Options.EXTRA_TOOL_BAR_COLOR, ContextCompat.getColor(this, R.color.ucrop_bg));
        ...
        mToolbarWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_COLOR_TOOLBAR, ContextCompat.getColor(this, R.color.ucrop_color_white));
        mToolbarCancelDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.drawable.ic_back);
    ...
    private void setupAppBar() {
        ...
        final Toolbar toolbar = findViewById(R.id.mTermsToolbar);

        // Set all of the Toolbar coloring
        toolbar.setBackgroundColor(Color.parseColor("#46D4E2"));
    ...
    private void addBlockingView() {
        if (mBlockingView == null) {
            ...
            lp.addRule(RelativeLayout.BELOW, R.id.mTermsToolbar);
